...
void Damage::set_dmg_die(int dmg_die){this->num_dmg_die=num_dmg_die;}
void Damage::set_bonus_dmg(int bonus_dmg){this->dmg_die=dmg_die;}
void Damage::set_num_dmg_die(int num_dmg_die){this->bonus_dmg=bonus_dmg;}
